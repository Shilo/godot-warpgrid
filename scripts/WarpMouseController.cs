...
{
    [Export] public float ForceStrength   = 2500.0f;  // PBD pixel-space brush, additive each tick
    [Export] public float ImpulseStrength = 8000.0f;  // PBD pixel-space middle-click punch
